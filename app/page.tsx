      ...
      <section className="py-20 grid-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { step: "01", title: "Connect & Verify",   icon: Zap,       desc: "Sign in with your Twitter account (must be X Premium / blue verified) and add your Solana wallet in your dashboard." },
              { step: "02", title: "Accept a Job",        icon: Zap,       desc: "Browse open jobs on the platform or accept directly from the Telegram bot/channel the moment a job drops." },
