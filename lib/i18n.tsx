...
const T = {
  en: {
    ...
    hero: {
      ...
      pre: "All In One ", blue: "Creator Economy", post: " Hub",
      subtitle: "Tasks, campaigns, digital products, quests, and rewards — everything to learn, work, earn, and grow in one platform",
      subtitleBold1: "", subtitleMid: "", subtitleBold2: "", subtitleEnd: "",
    ...
    joinUs: {
      badge: "Join Us",
      title: "Yapper Agent by Yapper Indo",
      subtitle: "It's more than just a platform, thousands of creators have successfully received their first payout here",
      xLabel: "X Community", xMembers: "12k+", xMembersLabel: "Active members", xCta: "Join Community",
      dcLabel: "Discord Server", dcMembers: "3k+", dcMembersLabel: "Active members", dcCta: "Join Server",
    },
    faq: {
      ...
      items: [
        ...
        { q: "What is a Campaign Job?",              a: "A job open to multiple creators at once. Each creator earns the full price, nothing is split. Slots close once filled, everyone submits proof independently." },
        ...
        { q: "What Happens if I Miss The Deadline?", a: "The deadline passes, the job auto-closes & your slot is marked missed. You won't receive payment for that job. Only accept jobs you can finish within the listed timeframe." },
      ],
    },
  },
  ...
  id: {
    ...
    hero: {
      ...
      pre: "All In One ", blue: "Creator Economy", post: " Hub",
      subtitle: "Tugas, kampanye, produk digital, quest, dan reward — semua untuk belajar, bekerja, menghasilkan, dan berkembang dalam satu platform",
      subtitleBold1: "", subtitleMid: "", subtitleBold2: "", subtitleEnd: "",
    ...
    joinUs: {
      badge: "Bergabung",
      title: "Yapper Agent by Yapper Indo",
      subtitle: "Lebih dari sekadar platform, ribuan kreator sudah berhasil menerima pembayaran pertama mereka di sini",
      xLabel: "Komunitas X", xMembers: "12k+", xMembersLabel: "Anggota aktif", xCta: "Gabung Komunitas",
      dcLabel: "Server Discord", dcMembers: "3k+", dcMembersLabel: "Anggota aktif", dcCta: "Gabung Server",
    },
    faq: {
      ...
      items: [
        ...
        { q: "Apa itu Pekerjaan Kampanye?",                  a: "Pekerjaan yang terbuka untuk beberapa kreator sekaligus. Setiap kreator mendapat bayaran penuh, tidak dibagi. Slot ditutup setelah penuh, semua mengirimkan bukti secara mandiri." },
        ...
        { q: "Apa yang Terjadi jika Saya Melewati Deadline?",a: "Saat deadline tiba, pekerjaan otomatis ditutup & slot kamu ditandai terlewat. Kamu tidak akan menerima bayaran untuk pekerjaan tersebut. Hanya terima pekerjaan yang bisa kamu selesaikan dalam batas waktu yang tertera." },
      ],
    },
  },
} as const;
