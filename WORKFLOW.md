...
flowchart TD
    ...
    NOTIF_LIST --> NOTIF_READALL[CheckCheck → mark all read\nPATCH /api/notifications?handle=xxx]
    ...
    CR4 -->|Campaign > 1| CR6[job_completions row created\nslots_taken++]
    ...
    subgraph CANCEL_REASONS["Cancel Reasons"]
        ...
        CR_3["client_cancelled  — reserved for future client-side cancellation (by design, not yet implemented)"]
    end
    ...
    class NOTIFCREATE admin
    class ESCROW_PEND,ESC1,ESC2,ESC3,ESC4 admin
